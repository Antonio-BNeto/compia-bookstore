...
import OrderSummary from './OrderSummary'; // Importa o componente que você enviou
...
export default function OrderItem({ order }) {
  ...
  return (
    <div className="bg-surface rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
      {/* Cabeçalho do Pedido (Sempre visível e clicável) */}
      <div 
        ...
        <div className="flex flex-col md:flex-row md:items-center md:gap-6">
          <div>
            ...
            <p className="text-sm text-text-muted">
              Realizado em: {new Date(order.date).toLocaleDate-String('pt-BR')}
            </p>
          </div>
      ...
      {/* Detalhes do Pedido (Visível quando expandido) */}
      {isOpen && (
        <div className="p-4 border-t border-gray-100 dark:border-gray-800">
          ...
          {/* Renderiza o componente de resumo que você me enviou */}
